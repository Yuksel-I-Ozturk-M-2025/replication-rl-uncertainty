function [alpha_fit,T_fit,rho_fit,LogML] = PWRL_fitting(params_init,r0,N,Ns,myfilename)
%[alpha_fit,T_fit,rho_fit,LogML] = PWRL_fitting([0.1,0.1,0.1],N,Ns,'Simulation1.mat');
...
function NeglogML = MLE_RL(free_params,N,Ns,r0,O,A,R)
...
f = @(free_params)MLE_RL(free_params,N,Ns,r0,O,A,R);
