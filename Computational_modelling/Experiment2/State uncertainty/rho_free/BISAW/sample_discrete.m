function sample = sample_discrete(prob)
%
% Slightly modified version of the original sample_discrete.m to make the simulation faster
% simply, I removed the checks for type as I use the file only with type =
% 'prob'
